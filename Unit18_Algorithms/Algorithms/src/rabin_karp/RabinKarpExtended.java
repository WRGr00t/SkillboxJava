...
public class RabinKarpExtended {
    ...
    public static void main(String[] args) {
        String txt = "Пердимонокль. Другими словами - конфуз. Нечто, вызывающее сильное удивление." +
                " Парадоксально, но это слово способно само вызвать конфуз." +
                " Особенно для тех людей, кто услышит его впервые.";
        String pattern = "то";
        RabinKarpExtended searchRK = new RabinKarpExtended(txt);
